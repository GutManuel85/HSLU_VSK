...
public final class GameOfLifeControls extends Panel {
    ...
    public void startStopButtonClicked() {
        ...
        StandaloneGameOfLife.LOGGER.debug("Start/Stop Button clicked!");
    }
    ...
    public void nextButtonClicked() {
        ...
        StandaloneGameOfLife.LOGGER.debug("Next Button clicked!");
    ...
    public void speedChanged(int speed) {
        ...
        StandaloneGameOfLife.LOGGER.debug("Speed changed to: " + speed + "ms");
    }
    ...
    public void zoomChanged(int zoom) {
        ...
        StandaloneGameOfLife.LOGGER.debug("Zoom level changed to: " + zoom);
    }
    ...
    public void shapeSelected(String shapeName) {
        ...
        StandaloneGameOfLife.LOGGER.debug("Shape selected to: " + shapeName);
    }
