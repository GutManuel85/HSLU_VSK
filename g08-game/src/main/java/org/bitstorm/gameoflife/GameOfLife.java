...
public class GameOfLife extends Applet implements Runnable, GameOfLifeControlsListener {
    ...
    public synchronized void run() {
        while (gameThread != null) {
            ...
            try {
                ...
                StandaloneGameOfLife.LOGGER.debug("Neuer Thread wird gestartet, Geschwindigkeit: " + genTime);
            } catch (InterruptedException e) {
                e.printStackTrace();
                StandaloneGameOfLife.LOGGER.error("InterruptedException, Class: GameOfLife, Method: run()",e);
            }
        }
    }
    ...
    public void shapeSelected(GameOfLifeControlsEvent e) {
        ...
        try {
            ...
            StandaloneGameOfLife.LOGGER.error("Shape Error!", e1);
        }
    }
}
