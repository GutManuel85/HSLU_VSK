...
public final class GameOfLifeGrid implements CellGrid {
    ...
    public GameOfLifeGrid(int cellCols, int cellRows) {
        ...
        StandaloneGameOfLife.LOGGER.debug("Grid created");
    }
    ...
    public synchronized void clear() {
        ...
        currentShape.clear();
        nextShape.clear();
        StandaloneGameOfLife.LOGGER.debug("Grid cleared");
    }
    ...
    public synchronized void addNeighbour(int col, int row) {
        try {
            ...
            StandaloneGameOfLife.LOGGER.error("Array Out of Bounds",e);
            // ignore
        }
    }
    ...
    public synchronized boolean getCell(int col, int row) {
        try {
            ...
            StandaloneGameOfLife.LOGGER.error("Index out of Boundes", e);
            // ignore
        }
        return false;
    }
    ...
    public synchronized void setCell(int col, int row, boolean c) {
        try {
            ...
            if (c) {
                ...
                StandaloneGameOfLife.LOGGER.trace("Cell (x=" + cell.getCol() + ", y=" + cell.getRow() + ") alive");
